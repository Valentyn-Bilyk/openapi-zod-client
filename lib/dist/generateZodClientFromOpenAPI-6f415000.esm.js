...
var getZodChainableStringValidations = function getZodChainableStringValidations(schema) {
  ...
  if (!schema["enum"]) {
    if (schema.minLength !== undefined) {
      var _schema$json_schema_e;
      var minMsg = (_schema$json_schema_e = schema.json_schema_extra) === null || _schema$json_schema_e === void 0 || (_schema$json_schema_e = _schema$json_schema_e.errorMessage) === null || _schema$json_schema_e === void 0 ? void 0 : _schema$json_schema_e.minLength;
      validations.push("min(".concat(schema.minLength, ", { message: ").concat(JSON.stringify(minMsg !== null && minMsg !== void 0 ? minMsg : "\u041C\u0430\u0454 \u0431\u0443\u0442\u0438 \u0449\u043E\u043D\u0430\u0439\u043C\u0435\u043D\u0448\u0435 ".concat(schema.minLength, " \u0441\u0438\u043C\u0432\u043E\u043B\u0456\u0432")), " })"));
    }
